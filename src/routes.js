export const ROUTES = {
    ...
    COMPRESS_TEXT_ASSETS: 'COMPRESS_TEXT_ASSETS',
    MY_PROMISE: 'MY_PROMISE',
    OBSERVE_STATE: 'OBSERVE_STATE',
    HTTP2_VS_HTTP1: 'HTTP2_VS_HTTP1',
...
export const ROUTES_URLS = {
    ...
    COMPRESS_TEXT_ASSETS: '/compress-text-based-assets',
    EXTENSIONS_IMPACT_ON_PERFORMANCE: '/extensions-impact-on-performance',
    CRITICAL_RENDERING_PATH: '/critical-rendering-path',
    MY_PROMISE: '/my-promise',
    OBSERVE_STATE: '/observe-state',
    HTTP2_VS_HTTP1: '/http2-vs-http1',
